...
class ActivateYourAccountScreen extends StatefulWidget {
  final String emailTxt;
  const ActivateYourAccountScreen({
    Key? key,
    required this.emailTxt,
  }) : super(key: key);

  @override
  State<ActivateYourAccountScreen> createState() => _SendEmailScreenState();
}

class _SendEmailScreenState extends State<ActivateYourAccountScreen> {
  TextEditingController emailController = TextEditingController();
  late SendEmailVerificationBloc sendEmailVerificationBloc;
  @override
  void initState() {
    // String email = widget.emailTxt;

    sendEmailVerificationBloc =
        BlocProvider.of<SendEmailVerificationBloc>(context);
  ...
  sentEmailVerification() async {
    String email = widget.emailTxt;
    sendEmailVerificationBloc.add(MentorSendEmailVerificationEvent(email));
  }
